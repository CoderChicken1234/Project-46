...
class Mars{
    constructor(){
        ...
        Human = createSprite(1300,350,200,200)
        ...
        HumanButton = createImg("./assets/Man.png")
        HumanButton.position(1130, 480)
        HumanButton.size(350,150)
        HumanButton.mouseClicked(this.humanFunction)
    ...
    O2function(){
     ...
     marsSpaceTentTabFunction(){
        marsSpaceTent.position.x = random(200,800)
     ...
     humanFunction(){
      Human.position.x = random(200,800)
      Human.position.y = random(200,600)
